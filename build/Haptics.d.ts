...
export interface HapticSequenceElement {
...
export declare function playHapticSequenceAsync(sequence: HapticSequenceElement[]): Promise<void>;

export declare function stopHapticSequence(): Promise<void>;
